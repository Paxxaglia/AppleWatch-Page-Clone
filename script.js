...
const tituloPorduto = document.getElementById('titulo-produto');
...
function trocarTamanho(){
    ...
    tituloPorduto.innerText = 'Pulseira loop esportiva ' + opcoesCores[corSelecionada].nome + ' para caixa de ' + opcoesTamanho[tamanhoSelecionado];
